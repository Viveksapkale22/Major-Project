...
def send_alert_email(email, frame, person_id, upload_folder="uploads"):
    import cv2
    import time
    ...
    msg["To"] = email
    msg.set_content("A person has been detected in a restricted area. See attached image.")
...
def detect_motion(frame, bg_subtractor=None):
    ...
    if bg_subtractor is not None:
        ...
        # Simple motion detection fallback if bg_subtractor is not provided
